...
<head>
    ...
    <title>Category Add/Update</title>
...
<body>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-title">
                            <h4>Category List And Add/Update Category</h4>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading border bottom">
                                        <h4 class="card-title">Category Add/Update</h4>
                                    </div>
                            ...
                            $udata = mysqli_fetch_assoc(mysqli_query($con,"select * from category where id=".$_GET['qid'].""));
                            ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="Enter Category Name" class="form-control" name="qtitle" value="<?php echo $udata['title'];?>" required>
                                                                </div>
                                                            </div>
                                                           </div> 
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <img src="<?php echo $udata['img'];?>" width="100px" height="100px">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <div class="text-right mrg-top-5">
                                                                    <button type="submit" name="up_quiz" class="btn btn-primary">Update Category</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                    ...
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Category Title</label>
                                                                    <input type="text" placeholder="Enter Category Title" class="form-control" name="qtitle" required>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <div class="text-right mrg-top-5">
                                                                    <button type="submit" class="btn btn-primary" name="sav_quiz">Create Category</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <th>Action</th>
                                               ...
                                               <tbody>
                                    <?php 
                                    $sel_list = mysqli_query($con,"select * from category");
                                    $i=0;
    ...
    {
        $qid = $_GET['qid'];
        mysqli_query($con,"delete from category where id=".$qid."");
        mysqli_query($con,"delete from product where cid=".$qid."");
        ?>
        <script>
            alert('successfully Delete Category');
          //alert('You Use Demo So It Can not Delete Category!!');
    ...
    {
        $qid = $_GET['s'];
        mysqli_query($con,"update category set status=".$qid." where id=".$_GET['pid']."");
        
        ?>
        <script>
            alert('successfully Change Status ');
            //alert('You Use Demo So It Can not Status!!');
            window.location.href="category.php";
        </script>
        <?php 
    }
...
$target_file = $target_dir . basename($names);
      ...
      mysqli_query($con,"insert into category(`title`,`img`)values('".$qtitle."','".$target_file."')");
     move_uploaded_file($_FILES["qduration"]["tmp_name"], $target_file);
     
      ?>
      <script>
         alert('Category Save Successfully!!');
        // alert('You Use Demo So It Can not Insert Category!!');
          window.location.href="category.php";
      </script>
      <?php 
	}
...
$target_file = $target_dir . basename($names);
 ...
 {
	    mysqli_query($con,"update category set title='".$qtitle."',img='".$target_file."' where id=".$_GET['qid']."");
  move_uploaded_file($_FILES["qduration"]["tmp_name"], $target_file);
     
 }
 else
 {
    mysqli_query($con,"update category set title='".$qtitle."' where id=".$_GET['qid'].""); 
 }
	    ?>
	     <script>
          alert('Update Category  Successfully!!');
    //  alert('You Use Demo So It Can not Update Category!!');
          window.location.href="category.php";
      </script>
	    <?php 
	}
