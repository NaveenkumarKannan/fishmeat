...
<body>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading border bottom">
                                        <h4 class="card-title">Testimonial Add/Update</h4>
                                    </div>
                            ...
                            $udata = mysqli_fetch_assoc(mysqli_query($con,"select * from testimonial where id=".$_GET['qid'].""));
                            ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Name</label>
                                                                    <input type="text" placeholder="Enter Title" class="form-control" name="name" value="<?php echo $udata['name'];?>">
                                                                </div>
                                                            </div>
                                                           </div> 
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Message</label>
                                                                    <textarea name="message" placeholder="Enter Message" class="form-control"><?php echo $udata['message'];?></textarea> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <div class="text-right mrg-top-5">
                                                                    <button type="submit" name="up_quiz" class="btn btn-primary">Update Testimonial</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                            ...
                            <?php } else {?>
                                                    <form method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <div class="text-right mrg-top-5">
                                                                    <button type="submit" class="btn btn-primary" name="sav_quiz">Create Testimonial</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <th>Action</th>
                                               ...
                                               <tbody>
                                    <?php 
                                    $sel_list = mysqli_query($con,"select * from testimonial");
                                    $i=0;
    ...
    {
        $qid = $_GET['qid'];
        mysqli_query($con,"delete from testimonial where id=".$qid."");
        
        ?>
        <script>
            alert('successfully Delete Testimonial');
          //alert('You Use Demo So It Can not Delete Testimonials!!');
    ...
    {
        $qid = $_GET['s'];
        mysqli_query($con,"update testimonial set status=".$qid." where id=".$_GET['pid']."");
	...
	if(isset($_POST['sav_quiz']))
	{
      ...
      mysqli_query($con,"insert into testimonial(`name`,`message`)values('".$name."','".$message."')");
     
     
      ?>
      <script>
          alert('Testimonial Save Successfully!!');
          //alert('You Use Demo So It Can not Insert Testimonials!!');
          window.location.href="addtest.php";
      </script>
      <?php 
	}
   ...
   mysqli_query($con,"update testimonial set name='".$name."',message='".$message."' where id=".$_GET['qid'].""); 
 
	    ?>
	     <script>
          alert('Update Testimonial  Successfully!!');
        //alert('You Use Demo So It Can not Update Testimonials!!');
          window.location.href="addtest.php";
      </script>
	    <?php 
	}
