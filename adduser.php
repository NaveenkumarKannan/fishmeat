...
<body>
                                ...
                                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <th>Status</th>
                                               ...
                                               <tbody>
                                    <?php 
                                    $sel_list = mysqli_query($con,"select * from register");
                                    $i=0;
                                    ...
                                    <tr>
                                       ...
                                       <a href="?s=0&pid=<?php echo $row['id'];?>"><button class="btn btn-danger"> Make Deactive</button></a>
                                       <?php }else{?>
                                       <a href="?s=1&pid=<?php echo $row['id'];?>"><button class="btn btn-primary"> Make Active</button></a>
                                       <?php }?>
									   <a href="address.php?aid=<?php echo $row['id'];?>"><button class="btn btn-info"> See Address</button></a>
									   </td>
    ...
    {
        $qid = $_GET['s'];
        mysqli_query($con,"update register set status=".$qid." where id=".$_GET['pid']."");
